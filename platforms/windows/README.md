...
- Nền cửa sổ là **gradient mềm** + card có đổ bóng, **tự đổi sáng/tối** theo `Palette.color-scheme`
  của Fluent (theo cài đặt Windows). Không dùng Mica vì transparency của Slint kém ổn định —
  gradient cho diện mạo nhất quán, đẹp trên mọi máy (giống bản Linux).
